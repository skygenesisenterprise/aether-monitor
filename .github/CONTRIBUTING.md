...
# Contributing to Aether Monitor

Thank you for your interest in contributing to **Aether Monitor**!  
...
**Aether Monitor** is the official Aether Monitor of Sky Genesis Enterprise, licensed under **Apache 2.0**, with both:
...
We follow a [Code of Conduct](https://github.com/skygenesisenterprise/aether-monitor/CODE_OF_CONDUCT.md) to ensure a safe, respectful, and inclusive environment.  
...
Open a [GitHub Discussion](https://github.com/skygenesisenterprise/aether-monitor/discussions)
Or reach out to us at [contact@skygenesisenterprise.com](mailto:contact@skygenesisenterprise.com)

Thank you for helping improve to Aether Monitor! 💌
