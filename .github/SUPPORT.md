...
Thank you for using **Aether Monitor** — the official Aether Monitor developed and maintained by [Sky Genesis Enterprise](https://skygenesisenterprise.com).
...
If you're using the open-source version of Aether Monitor and need help with:
...
- 🐞 [GitHub Issues](https://github.com/skygenesisenterprise/aether-monitor/issues) – for bug reports only
...
If you are using Aether Monitor in a professional or production environment and require:
...
Want to help improve for the Aether Monitor?  
